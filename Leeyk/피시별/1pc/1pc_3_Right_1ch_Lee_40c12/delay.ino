...
//////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////      dealy setting     (rd?? ==> rd_??) 변경  22.11.14
//////////////////////////////////////////////////////////////////////////////////////////////
bool macro_random_delay(int rd_v1, int ratio_v)      // rd_dealy10 추가  22.11.21
{
  int x = ratio_v * 5;
  int rd_v2 = rd_v1 + x;
  int rd_v3 = rd_v2 + x;              //  수식오류 수정 22.12.01
  return delay1(random(random(rd_v1, rd_v2), random(rd_v2, rd_v3)));
}

bool rd_10(int rd_v0)
{
  int ratio_v = 1;
  return macro_random_delay(rd_v0, ratio_v);
}
bool rd_20(int rd_v0)
{
  int ratio_v = 2;
  return macro_random_delay(rd_v0, ratio_v);
}
bool rd_30(int rd_v0)
{
  int ratio_v = 3;
  return macro_random_delay(rd_v0, ratio_v);
}
bool rd_40(int rd_v0)
{
  int ratio_v = 4;
  return macro_random_delay(rd_v0, ratio_v);
}
bool rd_50(int rd_v0)
{
  int ratio_v = 5;
  return macro_random_delay(rd_v0, ratio_v);
}
bool rd_60(int rd_v0)
{
  int ratio_v = 6;
  return macro_random_delay(rd_v0, ratio_v);
}
bool rd_70(int rd_v0)
{
  int ratio_v = 7;
  return macro_random_delay(rd_v0, ratio_v);
}
bool rd_80(int rd_v0)
{
  int ratio_v = 8;
  return macro_random_delay(rd_v0, ratio_v);
}
bool rd_90(int rd_v0)
{
  int ratio_v = 9;
  return macro_random_delay(rd_v0, ratio_v);
}
bool rd_100(int rd_v0)
{
  int ratio_v = 10;
  return macro_random_delay(rd_v0, ratio_v);
}
