...
char const  s_key01 = 'q';       //       S1()  진귀참
char const  s_key02 = 'w';        //       S2()  귀문진 범위기 120초, 40초
char const  s_key03 = 'e';        //      S3()  정령결속 지속기 120초, 30초
char const  s_key04 = 'r';        //     S4()  정령집속 지속기 120초. 30초
char const  s_key05 = 'a';        //        S5()  이동기
char const  s_key06 = 's';        //        S6() 로프
char const  s_key07 = 'd';        //      S7() 에르다 파운틴 40초, 60초
