...
char const  s_key01 = 'q';       //       S1()  범위기 10초
char const  s_key02 = 'w';        //       S2()  날리는 범위기 12초
char const  s_key03 = 'e';        //      S3()  범위기 3 90초
char const  s_key04 = 'r';        //     S4()  범위기 4 30초
char const  s_key05 = 'a';        //        S5()  없음
char const  s_key06 = 's';        //        S6() 로프
char const  s_key07 = 'd';        //      S7() 에르다 파운틴
