...
bool d_val(int r_val1)
{
  int r_val2 = r_val1 + 25;
  int r_val3 = r_val2 + 25;
  int d_value = random(random(r_val1, r_val2), random(r_val2, r_val3));
  return delay1(d_value);
}

//// 입력값 + 50ms 랜덤 딜레이 (1000=1000ms=1초)
bool rd_50(int rd50_val1)          // d_val ==> rd_50 으로 변경  22.11.14
{
  int rd50_val2 = rd50_val1 + 25;
  int rd50_val3 = rd50_val2 + 25;
  int d_value = random(random(rd50_val1, rd50_val2), random(rd50_val2, rd50_val3));
  return delay1(d_value);
}

//// 입력값 + 30ms 랜덤 딜레이 (1000=1000ms=1초)
bool rd_30(int rd30_val1)        // rd_30 추가  22.11.14
{
  int rd30_val2 = rd30_val1 + 15;
  int rd30_val3 = rd30_val2 + 15;
  int d_value = random(random(rd30_val1, rd30_val2), random(rd30_val2, rd30_val3));
  return delay1(d_value);
}
/*
void delay_value(int rdval_1, int random_value);
{
  int rdval2 = rdval_1 + random_value;
  int rdval3 = rdval_2 + random_value;
  int d_value_1 = random(rdval_1, rdval_2);
  int d_value_2 = random(rdval_2, rdval_3);
  int d_value_3= random(d_value_1, dvalue_2);
  return delay1(d_value_3);
}

bool d_main() {         // d_main() ==> attack_random_delay 변경
  return delay1(random(random(470, 500), random(500, 530)));

  
}
bool d_Main(dMain_val);
{
  int randdom_nomber = 
  int d = dMain_val
  delay_value(d, random_nomber)
