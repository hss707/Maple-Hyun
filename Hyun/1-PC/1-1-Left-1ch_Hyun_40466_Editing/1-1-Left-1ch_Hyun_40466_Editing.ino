...
unsigned long periodic_min1 = 10000;
unsigned long periodic_max1 = 11000;
unsigned long delay_1 = (( periodic_min1 + periodic_max1) / 2) - random(10, 100);

const char periodic_key2 = 1;
unsigned long periodic_millis2;
unsigned long periodic_min2 = 2400;
unsigned long periodic_max2 = 2500;
unsigned long delay_2 = delay_1 + (( periodic_min2 + periodic_max2) / 2);
delay_2 = delay_1 + random( periodic_min2, periodic_max2 );
...
unsigned long delay_3 = (( periodic_min3 + periodic_max3) / 2) - random(50, 100);
...
unsigned long delay_4 = (( periodic_min4 + periodic_max4) / 2) - random(50, 100);
...
unsigned long delay_5 = (( periodic_min5 + periodic_max5) / 2) - random(50, 100);
...
unsigned long delay_6 = (( periodic_min6 + periodic_max6) / 2) - random(50, 100);
...
unsigned long delay_7 = (( periodic_min7 + periodic_max7) / 2) - random(50, 100);
...
unsigned long delay_8 = (( periodic_min8 + periodic_max8) / 2) - random(50, 100);
...
unsigned long delay_9 = (( periodic_min9 + periodic_max9) / 2) - random(50, 100);
...
unsigned long delay_10 = (( periodic_min10 + periodic_max10) / 2) - random(50, 100);
