...
{
  { 0x10, 0, 0x3A, 0, 0, 0, 0, 0 } , // CTRL + F1
  { 0x10, 0, 0x3B, 0, 0, 0, 0, 0 } , // CTRL + F2
  { 0x10, 0, 0x3C, 0, 0, 0, 0, 0 } , // CTRL + F3
  { 0x10, 0, 0x3D, 0, 0, 0, 0, 0 } , // CTRL + F4
...
{
  { 0x10, 0, 0x1E, 0, 0, 0, 0, 0 } , // CTRL + 1
  { 0x10, 0, 0x1F, 0, 0, 0, 0, 0 } , // CTRL + 2
  { 0x10, 0, 0x20, 0, 0, 0, 0, 0 } , // CTRL + 3
  { 0x10, 0, 0x21, 0, 0, 0, 0, 0 } , // CTRL + 4
...
{
  { 0x20, 0, 0x1E, 0, 0, 0, 0, 0 } , // SHIFT + 1      // 11.01 수정
  { 0x20, 0, 0x1F, 0, 0, 0, 0, 0 } , // SHIFT + 2
  { 0x20, 0, 0x20, 0, 0, 0, 0, 0 } , // SHIFT + 3
  { 0x20, 0, 0x21, 0, 0, 0, 0, 0 } , // SHIFT + 4
...
{
  { 0x30, 0, 0x3A, 0, 0, 0, 0, 0 } , // CTRL + SHIFT + F1
  { 0x30, 0, 0x3B, 0, 0, 0, 0, 0 } , // CTRL + SHIFT + F2
  { 0x30, 0, 0x3C, 0, 0, 0, 0, 0 } , // CTRL + SHIFT + F3
  { 0x30, 0, 0x3D, 0, 0, 0, 0, 0 } , // CTRL + SHIFT + F4
...
{
  { 0x30, 0, 0x1E, 0, 0, 0, 0, 0 } , // CTRL + SHIFT + 1
  { 0x30, 0, 0x1F, 0, 0, 0, 0, 0 } , // CTRL + SHIFT + 2
  { 0x30, 0, 0x20, 0, 0, 0, 0, 0 } , // CTRL + SHIFT + 3
  { 0x30, 0, 0x21, 0, 0, 0, 0, 0 } , // CTRL + SHIFT + 4
...
char all_off_key[8]  =
  // 모든 채널 끄기 단축키
{
  0x10, 0, 0x29,  0, 0, 0, 0, 0 // CTRL + ESC
};

char all_macro_off_key[8]  =
  // 모든 채널 매크로 끄기 단축키
{
  0x10, 0, 0x45,  0, 0, 0, 0, 0 // CTRL + F12
};
