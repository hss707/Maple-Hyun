...
int arr[2] = {keys.lshift, keys.rshift};       // 주력기배치
int at[2] = {keys.lalt, keys.ralt};           // 1단점프
int jp[3] = {keys.lalt, keys.ralt, '.'};        // 2단점프


char const  s_key01 = 'q';       //       S1()  기가슬래셔
char const  s_key02 = 'w';        //       S2()  범위기  20초
char const  s_key03 = 'e';        //      S3()  범위기  60초
char const  s_key04 = 'r';        //     S4()  월오브스트라이크  30초
char const  s_key05 = 'a';        //        S5()  이동기
char const  s_key06 = 'x';        //        S6()  윌오브 차지  10초
char const  s_key07= 'c';        //        S7()  고대전사 소환 120초
char const  s_key08 = 's';        //        S8() 로프
char const  s_key09 = 'd';        //      S9() 에르다 파운틴
char const  s_key10 = 'z';        //      S10() 이동기 2
