...
char const  s_key01 = 'q';       //       S1()  범위기
char const  s_key02 = 'w';        //       S2()  위로 이동 범위기
char const  s_key03 = 'e';        //      S3()  앞으로 범위기
char const  s_key04 = 'a';        //     S4()  아래로 이동 범위기
char const  s_key05 = 's';        //        S5()  로프
char const  s_key06 = 'd';        //        S6()  에르다 파운틴
char const  s_key07= '1';        //        S7()  도력 회복
char const  s_key08 = '2';        //        S8() 지속기1
char const  s_key09 = '3';        //      S9() 지속기2
char const  s_key10 = '4';        //      S10() 지속기3
char const  s_key11 = '5';        //      S10() 지속기4
