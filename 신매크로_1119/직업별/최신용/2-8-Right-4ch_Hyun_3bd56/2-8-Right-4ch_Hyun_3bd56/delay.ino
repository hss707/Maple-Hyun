...
////////////////////////      dealy setting      
//////////////////////////////////////////////////////////////////////////////////////////////
bool macro_random_delay(int rd_v1, int ratio_v)      // rd_dealy10 추가  22.11.21
{
  int x = ratio_v * 5;
  int rd_v2 = rd_v1  + x;
  int rd_v3 = rd_v2 + (rd_v2 + x);
  return delay1(random(random(rd_v1, rd_v2), random(rd_v2, rd_v3)));
}
 
bool rd10(int rd_v0)        // rd_20 추가  22.11.14
{
  int r = 1;
  return macro_random_delay(rd_v0, r);
}
bool rd20(int rd_v0)        // rd_20 추가  22.11.14
{
  int r = 2;
  return macro_random_delay(rd_v0, r);
}
bool rd30(int rd_v0)        // rd_30 추가  22.11.14
{
  int r = 3;
  return macro_random_delay(rd_v0, r);
}
bool rd40(int rd_v0)        // rd_40 추가  22.11.14
{
  int r = 4;
  return macro_random_delay(rd_v0, r);
}
bool rd50(int rd_v0)    // d_val ==> rd50 으로 변경  22.11.21   // rd_40 추가  22.11.14
{
  int r= 5;
  return macro_random_delay(rd_v0, r);
}
bool rd60(int rd_v0)        // rd_60 추가  22.11.14
{
  int r = 6;
  return macro_random_delay(rd_v0, r);
}
bool rd70(int rd_v0)        // rd_70 추가  22.11.14
{
  int r = 7;
  return macro_random_delay(rd_v0, r);
}
bool rd80(int rd_v0)        // rd_80 추가  22.11.14
{
  int r = 8;
  return macro_random_delay(rd_v0, r);
}
bool rd90(int rd_v0)        // rd_90 추가  22.11.14
{
  int r = 9;
  return macro_random_delay(rd_v0, r);
}
